...
- `screenshots/01-hide-controls-1280x800.png` — actual Allegro search results with the extension's controls on regular cards.
...
Promotional artwork was generated with the built-in image generation tool using the project's 128 px icon as the visual reference. The final outputs were center-cropped and resized to the exact Chrome Web Store dimensions.
